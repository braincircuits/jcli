...
public class CaptchaConfig
{
    ...
    public static void main(String[] args)
    {
        ...
        DefaultKaptcha kaptchaBean = captchaConfig.getKaptchaBean();
        System.out.println(kaptchaBean.createText());
    }
    ...
    public DefaultKaptcha getKaptchaBeanMath()
    {
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, DefaultTextCreator.class.getName());
        // 验证码文本字符间距 默认为2
